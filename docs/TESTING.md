...
- Black-box only: Tests must use `package foo_test`. No white-box accessors on production types, no exported for-testing
 functions on production types. Dependencies controllable via constructor injection only.
