...
func CatppuccinoMacchiato() *Theme {
	return &Theme{
		...
		AboutTitleColour:               macchiatoMauve,
		AboutArtColour:                 macchiatoOverlay0,
		AboutTextColour:                macchiatoText,
		AboutLinkColour:                macchiatoBlue,
		AboutHintColour:                macchiatoOverlay0,
